...
import { basicCommand } from '@/console/commands/basic';
...
import { fastfetchCommand } from '@/console/commands/fastfetch';
import { filesystemCommands } from '@/console/commands/filesystem';
import { formatCommand } from '@/console/commands/format';
...
registry.register(fastfetchCommand);
