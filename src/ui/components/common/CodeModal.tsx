                ...
                <div className="custom-scrollbar flex h-full flex-col overflow-auto bg-background">
                    <div className="flex-1 py-4 font-mono text-sm leading-6">
                        {codeLines.map((lineNodes, i) => (
                            ...
                            >
                                <div
                                    className="code-block-line-number sticky left-0 z-(--z-index-content) w-16 flex-shrink-0 border-r border-border-subtle/20 bg-bg-secondary/30 pr-4 text-right text-muted-foreground/50 select-none"
